...
static void save_objects_json(const std::vector<Object>& objects, const char* filename)
{
    ...
    for (size_t i = 0; i < objects.size(); i++)
    {
        ...
        json_file << "  {\n";
        json_file << "    \"label\": \"" << class_names[obj.label] << "\",\n";
        json_file << "    \"confidence\": " << obj.prob << ",\n";
        json_file << "    \"box\": {\n";
        json_file << "      \"x\": " << obj.rect.x << ",\n";
        json_file << "      \"y\": " << obj.rect.y << ",\n";
        json_file << "      \"w\": " << obj.rect.width << ",\n";
        json_file << "      \"h\": " << obj.rect.height << "\n";
        json_file << "    }\n";
        json_file << "  }";
...
int yolov5_post_process(const char *imagepath, float **output)
{
    ...
    save_objects_json(objects, "results.json");
