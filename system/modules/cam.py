...
class Camera(History):
    ...
    def _run_inference_all(self, annotate):
    ...
    async def read(self, annotate=True):
        ...
        value = await asyncio.to_thread(self._run_inference_all, annotate)
        self.save_history(value, tick=capture_time)